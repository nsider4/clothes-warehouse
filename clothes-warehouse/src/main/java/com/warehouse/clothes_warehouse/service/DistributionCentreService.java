...
public class DistributionCentreService {
    ...
    public void addItem(Long centreId, String itemName, String itemBrand, int quantity, int year, double price) {
    ...
    public boolean transferItem(Long sourceCentreId, Long targetCentreId, String itemName, String itemBrand, int quantity, int year, double price) {
        ...
        Item sourceItem = sourceCentre.getItems().stream()
                .filter(item -> item.getName().equalsIgnoreCase(itemName)
                        && item.getBrand().equalsIgnoreCase(itemBrand))
                .findFirst()
                .orElse(null);
